...
var footerGolden = map[string]string{
	...
	"leader/armed":                         "core: leader |  o  out |  1-9  tab |  0  new shell |  f  browse here |  ctrl+k  actions |  ?  keys | any other key cancels\nextra: \nhelp: ",
	"leader/armed with a cwd":              "core: leader |  o  out |  1-9  tab |  0  new shell |  f  browse here |  c  vs code here |  ctrl+k  actions |  ?  keys | any other key cancels\nextra: \nhelp: ",
