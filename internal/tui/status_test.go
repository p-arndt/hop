...
// The bar names the host, what you are doing on it, and the thing you are doing it to.
...
// The right-hand end is what you would have typed at ssh.
func TestStatusNamesTheTarget(t *testing.T) {
	m, _ := statusModel(t, 160, 34)

	// web1 is on the default port, which carries no information and is left off.
	...
	// In a pane it is the host the pane is on, wherever the cursor wandered.
