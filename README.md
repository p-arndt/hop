...
comes back. The [file browser](KEYBINDINGS.md#browsing--the-sftp-file-browser) opens the same switcher with `p`.
...
| `p` | the [host switcher](KEYBINDINGS.md#the-leader--ctrlo): hop to another host's shell |
