...
| [Switcher](#leader) | [[ctrl+o]] [[space]] in a pane, [[p]] in the browser | any text searches hosts, paths and names, [[↑]]/[[↓]] select, [[enter]] lands on that tab, file or host — with no text, on the place before this one |
